...
public class Constants {
    ...
    public static final String REPORT_SERVICE = "statistics/actualSellsStats";
    ...
    public static String getReportServiceUrl() { return (HTTP + BASE_URL + LOCALHOST_PORT + REPORT_SERVICE); }
