...
class ProductLoader {
    def load() {
        ...
        new Product(name:'luminaria led', brand_id:4, image:'images/product/9', category:'iluminacion', characteristic:'Aplique exterior gris oscuro', stock:30, price:1850.0, state:'disponible').save()
        new Product(name:'sarten', brand_id:5, image:'images/product/10', category:'cocina', characteristic:'Sarten Profesional 30cm Acero Inoxidable 18/10', stock:100, price:1350.0, state:'disponible').save()
        new Product(name:'disco ssd', brand_id:6, image:'images/product/11', category:'electronica', characteristic:'Disco Rígido Estado Solido Ssd 240gb', stock:20, price:2600.0, state:'disponible').save()
        ...
        new Product(name:'reloj', brand_id:8, image:'images/product/13', category:'electronica', characteristic:'Fitbit Surge Gps Activity Tracking Watch (large)', stock:5, price:8500.0, state:'disponible').save()
