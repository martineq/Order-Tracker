...
class DiscountLoader {
    ...
    def load() {
        ...
        new Discount(product_id: 4, brand_id:2,range_from:1,range_upto:-1, category:'muebles', percentage: 3.33,datebeg: this.generateTimeInMs(calendar, year, month, monday, 0, 0),dateend: this.generateTimeInMs(calendar, year, month, wednesday, 0, 0)).save()
