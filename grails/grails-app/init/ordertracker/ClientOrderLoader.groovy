...
class ClientOrderLoader {
    def load() {
        ...
        new ClientOrder(seller_id:1, client_id:2, state:OrderStates.SOLICITADO.toString(), date: CalendarDate.fromCurrentDate(1), total_price:8415.50,sellername:seller2.name,clientname:client2.name).save()
        ...
        new ClientOrder(seller_id:4, client_id:9, state:OrderStates.SOLICITADO.toString(), date: CalendarDate.fromCurrentDate(1), total_price:11045.40,sellername:seller5.name,clientname:client5.name).save()
        ...
        new ClientOrder(seller_id:1, client_id:15, state:OrderStates.SOLICITADO.toString(), date: CalendarDate.fromCurrentDate(1), total_price:11045.40,sellername:seller6.name,clientname:client6.name).save()
        Agenda.executeUpdate(setState, [ state: ClientStates.VISITADO.toString(), seller_id: seller6.id, client_id: client6.id])
        Agenda.executeUpdate(setVisitedDate, [ visitedDate: CalendarDate.fromCurrentDate(1), seller_id: seller6.id, client_id: client6.id])
        
        
        
        def client7 = Client.findById(23)
        def seller7 = Seller.findById(6)
        new ClientOrder(seller_id:6, client_id:23, state:OrderStates.SOLICITADO.toString(), date: CalendarDate.fromCurrentDate(1), total_price:8415.50,sellername:seller7.name,clientname:client7.name).save()
        Agenda.executeUpdate(setState, [ state: ClientStates.VISITADO.toString(), seller_id: seller7.id, client_id: client7.id])
        Agenda.executeUpdate(setVisitedDate, [ visitedDate: CalendarDate.fromCurrentDate(1), seller_id: seller7.id, client_id: client7.id])
        ...
        new ClientOrder(seller_id:6, client_id:20, state:OrderStates.SOLICITADO.toString(), date: CalendarDate.fromCurrentDate(40), total_price:8415.50,sellername:seller8.name,clientname:client8.name).save()
        Agenda.executeUpdate(setState, [ state: ClientStates.VISITADO.toString(), seller_id: seller8.id, client_id: client8.id])
        Agenda.executeUpdate(setVisitedDate, [ visitedDate: CalendarDate.fromCurrentDate(1), seller_id: seller8.id, client_id: client8.id])
        ...
        new ClientOrder(seller_id:13, client_id:21, state:OrderStates.SOLICITADO.toString(), date: CalendarDate.fromCurrentDate(20), total_price:10000,sellername:seller9.name,clientname:client9.name).save()
        Agenda.executeUpdate(setState, [ state: ClientStates.VISITADO.toString(), seller_id: seller9.id, client_id: client9.id])
        Agenda.executeUpdate(setVisitedDate, [ visitedDate: CalendarDate.fromCurrentDate(1), seller_id: seller9.id, client_id: client9.id])
        ...
        new ClientOrder(seller_id:14, client_id:22, state:OrderStates.SOLICITADO.toString(), date: CalendarDate.fromCurrentDate(3), total_price:10000,sellername:seller10.name,clientname:client10.name).save()
        Agenda.executeUpdate(setState, [ state: ClientStates.VISITADO.toString(), seller_id: seller10.id, client_id: client10.id])
        Agenda.executeUpdate(setVisitedDate, [ visitedDate: CalendarDate.fromCurrentDate(1), seller_id: seller10.id, client_id: client10.id])
        
        
        
        
        new ClientOrder(seller_id:14, client_id:22, state:OrderStates.SOLICITADO.toString(), date: CalendarDate.fromCurrentDate(10), total_price:8500,sellername:seller10.name,clientname:client10.name).save()
        Agenda.executeUpdate(setState, [ state: ClientStates.VISITADO.toString(), seller_id: seller10.id, client_id: client10.id])
        Agenda.executeUpdate(setVisitedDate, [ visitedDate: CalendarDate.fromCurrentDate(1), seller_id: seller10.id, client_id: client10.id])
        ...
        new ClientOrder(seller_id:15, client_id:27, state:OrderStates.SOLICITADO.toString(), date: CalendarDate.fromCurrentDate(40), total_price:23.85,sellername:seller11.name,clientname:client11.name).save()
        Agenda.executeUpdate(setState, [ state: ClientStates.VISITADO.toString(), seller_id: seller11.id, client_id: client11.id])
        Agenda.executeUpdate(setVisitedDate, [ visitedDate: CalendarDate.fromCurrentDate(1), seller_id: seller11.id, client_id: client11.id])
